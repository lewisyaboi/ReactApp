  ...
  return (
    <SafeAreaView style={[globalStyles.safeArea, { backgroundColor: themedColors.back, flex: 1 }]}>
      ...
      <ScrollView 
        ...
        bounces={false}
      >
        {/* Removed internal static paddingTop styling to prevent overlap regressions */}
        <View style={[styles.container, { flex: 1, backgroundColor: themedColors.back, paddingBottom: 0 }]}>
